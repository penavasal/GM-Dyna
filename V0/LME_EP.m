...
function [B,near,p,gamma_,lam_LME,REMAP,wrap,EP,FAIL]=LME_EP(jacobians,...
    volume,x_a,xg,B,near,p,gamma_,lam_LME,wrap,EP)


    global elements sp h_ini Material Mat_nds B_BAR LME_param ...
    patch_con patch_el
    ...
    [B,near,p]=bbar_matrix...
        (x_a,patch_con,patch_el,elements,near,dp,p,volume,B,wrap,B_BAR);
    else
