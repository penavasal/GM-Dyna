 classdef FEM
    methods(Static)
        ...
        function [MAT_POINT]=shapef(i,coord,xilist,MAT_POINT)

            [~, N, dNdx, w,~] = FEM.elem_driver(coord,xilist);
        ...
        %  Set up integration points && weights    
           w = FEM.integrationweights(ncoord,nelnodes,npoints);
        %
        ...
        %
              ...
              N = FEM.shapefunctions(nelnodes,ncoord,xi);
              dNdxi = FEM.shapefunctionderivs(nelnodes,ncoord,xi);
